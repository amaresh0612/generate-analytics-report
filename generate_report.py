...
TEST_DATE = "10/20/20"#datetime.today  
...
#  states = ['Massachusetts', 'New Hampshire']
  ...
  #pdf.image("./tmp/usa_cases.png", x=10, y=30, w=90, h=60)
  pdf.image("./tmp/test.png", 5, 30, WIDTH/2-10) 
  pdf.image("./tmp/stacked_bar.png", WIDTH/2, 30, WIDTH/2-10)
  pdf.image("./tmp/usa_cases.png", x=5, y=120, w=190, h=90)
  ...
  # pdf.image("./tmp/cases_day.png", 5, 20, WIDTH/2-10)d
